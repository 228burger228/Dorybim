...
const works = [
  ...
  { cat: 'cafe',    img: 'pixel_cafe.png',   label: 'Пиксель-арт',  title: 'Кофейня · игровой проект',   color: '#E8D5C0', link: 'pixel.html' },
  { cat: 'chars',   img: 'pixel_chars1.png', label: 'Персонажи',    title: 'Посетители кофейни',          color: '#FFD8C0', link: 'pixel.html' },
  { cat: 'chars',   img: 'pixel_char2.png',  label: 'Персонаж',     title: 'Главная героиня',             color: '#E8D8F0', link: 'pixel.html' },
